...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002158617672"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002183883805"))
...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6421723947:AAGgkNzaemSU6aelkHF4V8Ssp8sf8djKQKY") 
...
DB_URL = os.environ.get("DB_URL", "mongodb+srv://adityakoloor2000:u123myaGDdyZVaVM@matrix0.odl191r.mongodb.net/?retryWrites=true&w=majority&appName=Matrix0")
#your database name
DB_NAME = os.environ.get("DB_NAME", "Matrix0")
...
OWNER_TAG = os.environ.get("OWNER_TAG", "matrix_freak")
...
TUT_VID = os.environ.get("TUT_VID","https://t.me/how_to_open_links_matrix")
